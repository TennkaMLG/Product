...
namespace kurs_shop
{
    ...
    {
        private string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Dev\c++test\kurs_shop_new\kurs_shop\kurs_shop\Database1.mdf;Integrated Security=True";
